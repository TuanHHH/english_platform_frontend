// // // components/reviews/course-reviews.js
// // "use client";
...
// //       // Nếu user đã đăng nhập, kiểm tra xem họ đã review chưa
// //       if (user) {
...
// //         setShowForm(false);
// //         setComment("");
// //         // Reload lại data để cập nhật list và thống kê
// //         fetchData(); 
// //       } else {
...
//       // --- SỬA LỖI TẠI ĐÂY ---
//       // Backend trả về { meta: ..., result: [...] } nên phải dùng .result
...
//       {/* Hiển thị review của chính mình nếu có */}
//       {myReview && (
//           <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 mb-6">
//               <p className="text-sm font-medium text-blue-800 mb-2">Đánh giá của bạn</p>
...
//                       <div className="text-xs text-muted-foreground">
//                         {myReview.createdAt &&
//                           formatDistanceToNow(new Date(myReview.createdAt), {
//                             addSuffix: true,
//                             locale: vi,
//                           })}
//                       </div>
    ...
    try {
      ...
      if (user) {
        ...
        if (myReviewRes.success) {
          ...
          setMyReview(null); // Reset nếu không có review (trường hợp vừa xóa)
        }
      }
    } catch (error) {
      console.error("Error fetching reviews:", error);
