...
const SearchComponent = ({
  ...
  <div className={`relative ${isMobile ? "w-full" : "w-96"}`} ref={searchRef}>
    ...
    <Input
      ...
      onFocus={() => {
        // TODO: tạm thời comment logic dropdown
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <h4 className="font-medium text-gray-900 truncate">{exam.examName}</h4>
                      <p className="text-sm text-gray-500 truncate">{exam.examDescription}</p>
