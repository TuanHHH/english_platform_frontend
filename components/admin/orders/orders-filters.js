        ...
        <Card className="mb-4">
            ...
            <CardContent className="p-3 sm:p-4 pt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {/* Status Filter */}
                    <div>
                        <Label className="text-xs sm:text-sm text-gray-600 mb-2 block">Trạng thái</Label>
                    ...
                    {/* Date Range Filter */}
                    <div>
                        <Label className="text-xs sm:text-sm text-gray-600 mb-2 block">Khoảng thời gian</Label>
                        <Popover>
                            ...
                            <PopoverContent className="w-auto p-0" align="start">
                                <div className="[&_.rdp-head_row]:hidden">
                                    <Calendar
                                        mode="range"
                                        selected={{
