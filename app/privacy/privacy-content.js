    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            <div className="mb-6">
                ...
                <p className="text-gray-600">Cập nhật lần cuối: Tháng 9, 2025</p>
            </div>
            ...
            <div className="prose prose-gray max-w-none">
                <section className="mb-8">
                    ...
                    <p className="text-gray-700 mb-4">
                        English Pro cam kết bảo vệ quyền riêng tư và thông tin cá nhân của người dùng. Chính sách
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Cookies và các công nghệ theo dõi</h2>
                    <p className="text-gray-700 mb-4">
