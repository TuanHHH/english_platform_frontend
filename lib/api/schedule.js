...
export async function createStudyPlan(data) {
  try {
    ...
    return { success: false, error: "Tạo kế hoạch học tập thất bại" };
  } catch (err) {
    return {
      success: false,
      error: "Tạo kế hoạch học tập thất bại"
    };
  }
}
...
export async function updateStudyPlan(id, data) {
  try {
    ...
    return { success: false, error: "Cập nhật kế hoạch học tập thất bại" };
  } catch (err) {
    const code = err?.response?.data?.code;
    if (code === ErrorCode.RESOURCE_NOT_FOUND) {
      return { success: false, error: "Không tìm thấy kế hoạch học tập" };
    }
    return {
      success: false,
      error: "Cập nhật kế hoạch học tập thất bại"
    };
  }
}
...
export async function deleteStudyPlan(id) {
  try {
    ...
    return { success: false, error: "Xóa kế hoạch học tập thất bại" };
  } catch (err) {
    const code = err?.response?.data?.code;
    if (code === ErrorCode.RESOURCE_NOT_FOUND) {
      return { success: false, error: "Không tìm thấy kế hoạch học tập" };
    ...
    return {
      success: false,
      error: "Xóa kế hoạch học tập thất bại"
    };
  }
}
...
export async function generateAIPlan(data) {
  try {
    ...
    return { success: false, error: "Tạo kế hoạch thất bại" };
  } catch (err) {
    return {
      success: false,
